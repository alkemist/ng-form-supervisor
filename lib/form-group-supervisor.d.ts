...
export declare class FormGroupSupervisor<DATA_TYPE, FORM_GROUP_TYPE extends FormGroup<FormGroupGeneric<DATA_TYPE>>> extends FormSupervisor<DATA_TYPE, FORM_GROUP_TYPE> {
    supervisors: SupervisorRecord<DATA_TYPE, FORM_GROUP_TYPE>;
    protected group: FORM_GROUP_TYPE;

    constructor(group: FORM_GROUP_TYPE, data?: DATA_TYPE, determineArrayIndexFn?: ((paths: ValueKey[]) => ValueKey) | undefined);
