...
export declare type ControlRawValueType<T extends AbstractControl> = T extends AbstractControl ? (T['setValue'] extends ((v: infer R) => void) ? R : never) : never;
...
export type PartialGroupValueType<FORM_GROUP_INTERFACE extends FormGroupInterface<any>, DATA_TYPE> = RecursivePartial<{
    [K in keyof FORM_GROUP_INTERFACE]: ControlRawValueType<FORM_GROUP_INTERFACE[K]>;
}>;
export type FormDataType<DATA_TYPE, FORM_TYPE extends AbstractControl> =
    DATA_TYPE
    | GroupValueType<GetFormGroupGenericClass<FORM_TYPE, DATA_TYPE>, DATA_TYPE>;
export type FormRawDataType<DATA_TYPE, FORM_TYPE> =
    DATA_TYPE
...
export type FormArrayItemInterfaceType<DATA_TYPE, FORM_ARRAY_ITEM_TYPE> = {
    interface: FORM_ARRAY_ITEM_TYPE extends FormGroup ? FormArrayGroupInterfaceType<DATA_TYPE, FORM_ARRAY_ITEM_TYPE> : FormArrayControlItemInterfaceType;
    validator: () => {};
};
